...
class AddNegaraTitip :  UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        if PostTitipJuga.varNegara.status != 0 {
            negaraText.text = PostTitipJuga.varNegara.negara
            provinsiText.text = PostTitipJuga.varNegara.provinsi
            kotaText.text = PostTitipJuga.varNegara.kota
    ...
    @objc func handleSubmit(){
        ...
        if negaraText.text != "" && provinsiText.text != "" && kotaText.text != ""{
            PostTitipJuga.varNegara.negara = negaraText.text!
            PostTitipJuga.varNegara.kota = kotaText.text!
            PostTitipJuga.varNegara.provinsi = provinsiText.text!
            PostTitipJuga.varNegara.idKota = selectedCity
            PostTitipJuga.varNegara.status = 1
            
            print(PostTitipJuga.varNegara.negara.self)
