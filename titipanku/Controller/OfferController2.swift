...
class OfferController2 :  UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "Bantu Belikan 2"
        collectionView?.backgroundColor = UIColor.white
        print("Bantu belikan Barang Loaded")
        
        collectionView?.register(AppDetailCell2.self, forCellWithReuseIdentifier: CellId)
        collectionView?.register(OfferNextCell2.self, forCellWithReuseIdentifier: OfferNextCellId)
    ...
    func showOffer(_ app: App) {
        ...
        let appDetailController = OfferController3(collectionViewLayout: layout)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == 0 {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CellId, for: indexPath) as! AppDetailCell2
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: OfferNextCellId, for: indexPath) as! OfferNextCell2
