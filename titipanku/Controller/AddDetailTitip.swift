...
class AddDetailTitip :  UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        if PostTitipJuga.varDetail.status != 0 {
            ...
            qtyText.text = PostTitipJuga.varDetail.qty
            descText.text = PostTitipJuga.varDetail.desc
            categoryText.text = PostTitipJuga.varDetail.kategori
            urlText.text = PostTitipJuga.varDetail.url
            cekGambar = 1
        }
    ...
    @objc func handleSubmit(){
        ...
        if cekGambar != 0 && nameText.text != "" && qtyText.text != "" && descText.text != "" && categoryText.text != "" {
            PostTitipJuga.varDetail.gambarBarang = BarangImageView.image
            PostTitipJuga.varDetail.namaBarang = nameText.text!
            PostTitipJuga.varDetail.qty = qtyText.text!
            PostTitipJuga.varDetail.desc = descText.text!
            PostTitipJuga.varDetail.kategori = categoryText.text!
            PostTitipJuga.varDetail.url = urlText.text!
        ...
        print(PostTitipJuga.varDetail.namaBarang.self)
    }
